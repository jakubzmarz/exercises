def isPrime(x):
    half = x/2                  
    for i in range(2, int(half)): #i startuje od 2 do polowy, bo 1 nas nie obchodzi
...
print(isPrime(prime))             #tu sie najpierw wykona funkcja wewnatrz nawiasow isPrime, ktorej przekazalismy argument prime
